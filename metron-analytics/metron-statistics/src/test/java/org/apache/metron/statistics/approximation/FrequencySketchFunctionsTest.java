...
public class FrequencySketchFunctionsTest {
  ...
  public void initializes_function() {
    FrequencySketch fi = (FrequencySketch) new Init()
        .apply(ImmutableList.of(4));
  ...
  public void init_throws_exception_on_bad_params() {
    exception.expect(IllegalArgumentException.class);
    exception.expectMessage("The value of the parameter \"maxMapSize\" must be a positive integer-power of 2 and greater than 0");
  ...
  public void calculates_exact_frequencies_for_specific_object() {
    FrequencySketch fi = (FrequencySketch) new Init()
        .apply(ImmutableList.of(8));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "a"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "a"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, ImmutableList.of("a", "a")));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "b"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "b"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, ImmutableList.of("b", "b")));
    {
  ...
  public void calculates_exact_frequencies_of_many_objects() {
    FrequencySketch fi = (FrequencySketch) new Init()
        .apply(ImmutableList.of(16));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "a"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "b"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, "c"));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 1));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 2));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 3));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 1L));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 2L));
    fi = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi, 3L));
    List<ItemEstimate> itemEstimates = (List) new Estimate()
        .apply(ImmutableList.of(fi));
  ...
  public void merges_frequency_checks() {
    FrequencySketch fi1 = (FrequencySketch) new Init()
        .apply(ImmutableList.of(16));
    fi1 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi1, "a"));
    fi1 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi1, "a"));
    fi1 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi1, "a"));

    FrequencySketch fi2 = (FrequencySketch) new Init()
        .apply(ImmutableList.of(16));
    fi2 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi2, "a"));
    fi2 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi2, "a"));
    fi2 = (FrequencySketch) new Update()
        .apply(ImmutableList.of(fi2, "a"));
  ...
  public void merge_with_self_is_identity_function() {
    ...
    itemEstimates = (List) new Estimate()
        .apply(ImmutableList.of(mergedFi, "b"));
